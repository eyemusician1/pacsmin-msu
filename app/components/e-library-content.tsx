          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="group hover:shadow-xl hover:scale-[1.02] transition-all duration-300 ease-in-out border-navy-100 hover:border-gold-300">
              ...
              <CardContent>
                ...
                <Button variant="link" className="mt-2 p-0 h-auto text-gold-600 hover:text-gold-800">Access Journal</Button>
              </CardContent>
            </Card>
            <Card className="group hover:shadow-xl hover:scale-[1.02] transition-all duration-300 ease-in-out border-navy-100 hover:border-gold-300">
              <CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="group hover:shadow-xl hover:scale-[1.02] transition-all duration-300 ease-in-out border-navy-100 hover:border-gold-300">
              ...
              <CardContent>
                ...
                <Button variant="link" className="mt-2 p-0 h-auto text-gold-600 hover:text-gold-800">Read Online</Button>
              </CardContent>
            </Card>
            <Card className="group hover:shadow-xl hover:scale-[1.02] transition-all duration-300 ease-in-out border-navy-100 hover:border-gold-300">
              <CardHeader>
