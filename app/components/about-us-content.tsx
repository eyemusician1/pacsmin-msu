...
export function AboutUsContent() {
  return (
    <div className="space-y-6 animate-fade-in-slide-up">
      ...
      <Card className="group hover:shadow-xl hover:scale-[1.01] transition-all duration-300 ease-in-out border-navy-100 hover:border-gold-300">
        <CardHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="group hover:shadow-xl hover:scale-[1.01] transition-all duration-300 ease-in-out border-navy-100 hover:border-gold-300">
          ...
          <CardContent className="space-y-2 text-gray-700">
            <p>Email: <a href="mailto:support@pacsmin.edu" className="text-gold-600 hover:underline">support@pacsmin.edu</a></p>
        ...
        <Card className="group hover:shadow-xl hover:scale-[1.01] transition-all duration-300 ease-in-out border-navy-100 hover:border-gold-300">
          ...
          <CardContent className="space-y-2 text-gray-700">
            ...
            <Button variant="link" className="p-0 h-auto text-gold-600 hover:underline">Meet the Team</Button>
          </CardContent>
        </Card>
      </div>
    </div>
